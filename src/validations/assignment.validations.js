...
export const assignmentInsertionValidations = z.object({
    ...
    description: z.string().trim().min(5, " Description should have at least five characters").max(30, " Description shouldn't go beyond 30 characters."),
    totalMarks:z.number().int().positive(),
    batchNo:z.number().int(),
    status:z.enum(["PENDING", "LIVE", "CLOSED"])
})